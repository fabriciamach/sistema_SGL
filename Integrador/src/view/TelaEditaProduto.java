...
import controller.EditaProdController;

public class TelaEditaProduto extends JFrame{
		...
		private JButton BotSalvarEdProd;
		...
		public void setPreco(Double preco) {
			String valor =  Double.toString(preco);
		...
		public void settTam(int tTam) {
			String tam = Integer.toString(tTam);
			this.tTam.setText(tam);
		}


		public JButton getBotSalvarEdProd() {
			return BotSalvarEdProd;
		}


		public void setBotSalvarEdProd(JButton botSalvarEdProd) {
			BotSalvarEdProd = botSalvarEdProd;
		}
		...
		public TelaEditaProduto() {
			...
			JLabel MsgCadastroProd = new JLabel("Editar Produto ");
			...
			BotSalvarEdProd = new JButton("Salvar");
			BotSalvarEdProd.setFont(new Font("Berlin Sans FB Demi", Font.PLAIN, 20));
			BotSalvarEdProd.setBounds(135, 352, 144, 43);
			contentPane.add(BotSalvarEdProd);
		...
		public void registerListener(EditaProdController controller) {
			BotSalvarEdProd.addActionListener(controller);
		}
