...
import controller.VendaGerController;

public class TelaVendaGer extends JFrame {
	...
	public void setProdVenda(String dadosProduto) {
	...
	public void registerListener(VendaGerController controller) {
